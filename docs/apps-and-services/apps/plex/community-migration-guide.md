...
![perms](./img/community-migration-guide/media-dataset-perms.png)
...
![truetool-mount-list](./img/community-migration-guide/truetool-mount-list.png)
...
![bad-hostpath-plex](./img/community-migration-guide/plex-config-volume-hostpath.png)
...
![error 503](./img/community-migration-guide/plex-503-error.png)
